...
def send_email_alert(message):
    # Email configuration
    sender_email = "iotmail1038@gmail.com"  # Replace with your email address
    receiver_email = "sakaharshavardhan@gmail.com"  # Replace with the recipient's email address
    password = "dgir wgfh nraf geas"  # Replace with your email password
				...
				# If ISBN record found then book is been borrow or returned on user's data
					...
					for i in range(len(list2)):
						if count == 1:
								...
								current_date = datetime.datetime.strptime(list2[i][4], "%d-%m-%Y")
								difference = datetime.datetime.now() - current_date
								days_difference = difference.days

								# Check if issue date is more than 5 days
								if days_difference > 5:
									send_email_alert("Library Alert!")
